...
A new package will be pushed to Nuget anytime `Cosmos.Template.nuspec` is changed on `main` branch.  Normally this will happen via a package version change.

Version needs to be updated in:

-  `Cosmos.Template.nuspec`
-  `Cosmos.Template.csproj`
